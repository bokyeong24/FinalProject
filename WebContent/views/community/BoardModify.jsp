							...
							<div class="title_wrap form-inline">
								<div class="select_wrap" style="margin-left:27px;margin-top:13px;">
									<select class="form-control">
										...
										<option value="d" selected="selected">일상</option>
										<option value="r">후기</option>
										<option value="q">묻고답하기</option>
									</select>
								</div>
								<input type="text" id="title" name="title" value="첫 생일파티 했어요ㅎㅎ" class="form-control" placeholder="제목을 입력해주세요."
								style="margin-left:27px; margin-top:13px; width: 610px;">
							</div><!-- .title_wrap end -->
...
그저께 생일파티 했습니다!
케익도 먹고 아주 행복한 하루를 보냈어요
이제 1살이니까 더 의젓한 꿀비가 될거예요~!
					                        </textarea>
					                    </div>
									</div><!-- .edSec end -->
