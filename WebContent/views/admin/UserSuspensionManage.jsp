...
<script type="text/javascript">
	function detail()
	{
		window.open("UserSuspentionDetail.jsp", "", "width=800, height=800, top=300, left=400");
	}
		...
		<div style="margin-bottom: 70px;">
			...
			<table class="table">
				...
				<tr>
					...
					<td>1</td>
					<td><a href="javascript:detail();">1234512</a></td>
					<td>ksd1026</td>
					<td>쩌리잇</td>
					<td>2020-12-31 13:02:15</td>
					<td><a href="javascript:detail();" class="btn btn-default">내역보기</a></td>
				</tr>
			</table>
		</div>
